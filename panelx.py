...
OTP_GROUP_ID = -1004481791705

# ==================== WELCOME MESSAGE CONFIGURATION ====================
WELCOME_MESSAGE = """⚡             𝗣𝗔𝗡𝗘𝗟 𝗫 𝗕𝗢𝗧             ⚡ 
━━━━━━━━━━━━━━━━━━━━━━
...
SUPPORT_LINK = "https://t.me/panel_x_support"      # সাপোর্ট লিংক পরিবর্তনযোগ্য
...
async def monitor_loop(app):
    while True:
        try:
            # নতুন সাইটের API - success-otp-info
            ...
            # নতুন রেসপন্স ফরম্যাট অনুযায়ী ডাটা এক্সট্র্যাক্ট
            otps = []
            ...
            if otps:
                ...
                for otp in otps:
                    ...
                    # নতুন সাইটের platform/service ডিটেকশন
...
async def fetch_number_async(range_str):
    """
    নতুন সাইটের API অনুযায়ী নম্বর ফেচ করার অপ্টিমাইজড ফাংশন
    """
    try:
        # নতুন সাইটের API এন্ডপয়েন্ট - POST মেথড
        url = f"{BASE_URL}/api/getnum"
        
        # নতুন সাইটের রিকোয়েস্ট বডি ফরম্যাট
        payload = {"range": range_str}
        
        r = await client_async.post(url, json=payload)
        ...
        # নতুন রেসপন্স ফরম্যাট চেক - meta.code 2946 মানে Out of Stock
...
async def fast_allocate_number_multi(query, context, ranges_list, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton("🔄 CHANGE NUMBER", callback_data="same_range", style="primary")],
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/panelx_sk_otp", style="primary")]
    ])
    try:
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "SUPPORT" in text:
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/shuvojit46", style="danger")]
        ])
...
async def profile_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    profile_text = (
        ...
        f"✨ TODAY: 📱 {stats['today_numbers']} | 🔑 {stats['today_s']}\n"
        f"🔥 7 DAYS: 📱 {stats['last7d_numbers']} | 🔑 {stats['last7d_otps']}\n"
        f"🌐 ALL TIME: 📱 {stats['total_numbers']} | 🔑 {stats['total_otps']}"
    )
    keyboard = InlineKeyboardMarkup([
